...
namespace EST.MIT.Approvals.Data.Migrations
{
    ...
    [Migration("20230619122130_UpdateEntitiesBasedOnERD")]
    partial class UpdateEntitiesBasedOnERD
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EST.MIT.Approvals.Data.Models.ApproverSchemeGradeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_approver_scheme_grades");

                    b.HasIndex("ApproverId")
                        .HasDatabaseName("ix_approver_scheme_grades_approver_id");

                    b.HasIndex("SchemeGradeId")
                        .HasDatabaseName("ix_approver_scheme_grades_scheme_grade_id");

                    b.ToTable("approver_scheme_grades", (string)null);
                });
            ...
            modelBuilder.Entity("EST.MIT.Approvals.Data.Models.ApproverSchemeGradeEntity", b =>
                {
                    b.HasOne("EST.MIT.Approvals.Data.Models.ApproverEntity", "Approver")
                        .WithMany()
                        .HasForeignKey("ApproverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_approver_scheme_grades_approvers_approver_id");
                    ...
                    b.HasOne("EST.MIT.Approvals.Data.Models.SchemeGradeEntity", "SchemeGrade")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_approver_scheme_grades_scheme_grades_scheme_grade_id");
